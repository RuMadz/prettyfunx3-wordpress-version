...
<main id="primary" class="site-main">
    ...
    <form id="contact-form">
        ...
        <p>My
            ...
            and I am contacting you from <input type="text" name="your-business" id="your-business" minlength="3"
                placeholder="(your business)" required>.
        </p>

        <p>My
            <label for="email">email address</label> is
            <input type="email" name="your-email" id="email" placeholder="(your email address)" required>. I look
            forward to hearing from you within the next 24 hours to discuss further.
        </p>
    ...
    <small class='website'>Vist <a href='https://www.erlen.co.uk/' target='_blank'>erlen.co.uk</a> to see my
        work</small>
